...
class TableTask extends Task {
	...
	private function displaySetupHelp() {
		...
		echo self::TAB_CHARACTER.$this->getDI()->get('configPhalconmerce')->modelsDir . PHP_EOL;
		echo PHP_EOL;
		echo 'Usage :' . PHP_EOL;
		echo self::TAB_CHARACTER.'php app/cli.php [options] table setup [ClassName]' . PHP_EOL . PHP_EOL;
